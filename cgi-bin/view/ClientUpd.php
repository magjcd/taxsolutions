...
<form action="index.php?page=ClientUpd&eid=<?php echo $_GET['eid']; ?>" method="post" style="margin-left: auto; margin-right: auto;">
	<div class="row double-column">
		...
		<div class="col-md-6">
			...
			<input type="text" name="uID" placeholder="User ID" value="<?php echo $clData['userId']; ?>"><br />
			<input type="text" name="cName" placeholder="Client Name" value="<?php echo $clData['clientNm']; ?>" class="reqFlab"><br />

			<textarea name="cAddr" cols="10" rows="3" placeholder="Client Address"><?php echo $clData['clientAddr']; ?></textarea><br />
			<input type="number" name="cnicNo" placeholder="CNIC without Dashes" value="<?php echo $clData['cnicNo']; ?>" class="reqFlab" dir="ltr"><br />
			...
			<input type="text" name="bussName" placeholder="Business Name" value="<?php echo $clData['busNm']; ?>" class="reqFlab"><br />
			<input type="text" name="ptclNo" placeholder="PTCL No." value="<?php echo $clData['ptclNo']; ?>"><br />
			<input type="tel" name="CellNo1" placeholder="Cell No. 1" 
			pattern="^[\+]{1}[0-9]{2}[0-9]{3}[0-9]{7}$" title="+923331234567" value="<?php echo $clData['cellNo1']; ?>"><br />
			<input type="text" name="rtoCno2" placeholder="Cell No. 2" 
			pattern="^[\+]{1}[0-9]{2}[0-9]{3}[0-9]{7}$" title="+923331234567" value="<?php echo $clData['cellNo2']; ?>"><br />
			<textarea name="bussAdd" placeholder="Businness Address"><?php echo $clData['busAddr']; ?></textarea>
			...
			value="<?php //echo $classification; ?>"><br /> -->
	...
	<div class="row double-column"> -->
		<div class="col-12" style="text-align: center;">
			<button type="submit" name="UpdClient">Update</button>
